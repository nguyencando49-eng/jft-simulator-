...
export const adminApi={
  ...
  productionRelease:()=>raw<{ok:true;ready:boolean;bankCount:number;expectedBankCount:number;publishedVersionIds:string[];missingVersionIds:string[];report:ProductionReleaseReport}>('/api/v1/admin/production-release'),
  ...
  system:()=>raw<{ok:true;ready:boolean;authoringReady:boolean;blockers:string[];authoringBlockers:string[];repository:string;authentication:string;assetStorage:string;aiFactory:string;apiVersion:string}>('/api/v1/system'),
