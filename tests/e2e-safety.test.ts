...
afterEach(()=>{
  ...
  if(originalAuthDisabled===undefined) delete mutableEnv.AUTH_DISABLED; else mutableEnv.AUTH_DISABLED=originalAuthDisabled;
  if(originalSupabaseUrl===undefined) delete mutableEnv.SUPABASE_URL; else mutableEnv.SUPABASE_URL=originalSupabaseUrl;
});
...
describe('production authentication safety',()=>{
  it('cannot be disabled by AUTH_DISABLED in production',()=>{
    mutableEnv.AUTH_DISABLED='true';mutableEnv.NODE_ENV='production';delete mutableEnv.SUPABASE_URL;
