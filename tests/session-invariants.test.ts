...
const version:ExamVersion={id:'e-v1',examId:'e',version:1,title:'E',durationMinutes:60,createdAt:'2026-01-01T00:00:00Z',publishedAt:'2026-01-01T00:00:00Z',rules:[{section:'script_vocabulary',count:1,allowBack:true,levels:['A2.1']},{section:'listening',count:2,allowBack:false,levels:['A2.1']}],questions:[q('q1','script_vocabulary'),q('q2','listening'),q('q3','listening')].map(x=>({questionId:x.id,questionVersion:1,snapshot:x}))};
